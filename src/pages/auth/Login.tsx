...
const Login  = ({ backGroundImage }: AuthProps): JSX.Element => {
  ...
  return (
    <section className="background overlay flex items-center justify-center " style={background_image_path}>
      ...
      <div className="flex rounded-2xl p-5 justify-center">
        {/* form */}
        <div className="md:w-1/2 px-8 md:px-24 py-24 space-y-8 ">
          <h1 className=" mt-2 text-white">  Enter your email and password to access your account </h1>
        ...
        <div className="md:block hidden w-1/2">
          <img
            className="right-section rounded-2xl w-screen h-screen"
            src={backGroundImage}
          />
        </div>
      </div>
